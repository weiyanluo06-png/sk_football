window.PONYTAIL_DATA = {
    players: [
        ...
        { id: 7, name: '吴宇泽', nickname: '53', number: 15, pos: 'FW', apps: 9, goals: 6, asts: 1, role: 'LWF/CF', saves: 0, cleanSheets: 0, motm: 0, rating: 8.4, avatarIcon: 'fa-person-running', traits: ['抢点型前锋'], memory: '贡献 6 粒进球 / 送出 1 次助攻', reviews: ['爸爸', '姆巴佩'], bio: '场上可胜任左边锋和中锋。', photo: 'assets/players/wuyuze.jpg' },
        ...
        { id: 9, name: '周霄旭', nickname: '生康未来', number: 5, pos: 'FW', apps: 10, goals: 4, asts: 3, role: 'CF/RWF/AM', saves: 0, cleanSheets: 0, motm: 0, rating: 8.4, avatarIcon: 'fa-person-running', traits: ['全能前锋'], memory: '贡献 4 粒进球 / 送出 3 次助攻', reviews: ['生康未来', '贝林厄姆', '生康球王'], bio: '场上可胜任中锋、右边锋和攻击型中场。' },
        ...
        { id: 13, name: '吴全银', nickname: '控场', number: 25, pos: 'MF', apps: 3, goals: 0, asts: 0, role: 'DM/RB', saves: 0, cleanSheets: 0, motm: 0, rating: 6.8, avatarIcon: 'fa-compass', traits: ['全能中场'], memory: '累计出场 3 场', reviews: ['生康罗德里'], bio: '场上可胜任后腰和右后卫。' },
