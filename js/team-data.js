window.PONYTAIL_DATA = {
    players: [
        { id: 1, name: '吴宇成', nickname: '铁血后卫', number: 6, pos: 'DF', apps: 10, goals: 0, asts: 1, role: 'CB/CM/GK', saves: 0, cleanSheets: 0, motm: 0, rating: 7.6, avatarIcon: 'fa-shield-halved', traits: ['后场组织者/进攻型门将'], memory: '送出 1 次助攻', reviews: ['铁血后卫+天才门将', '六边形战士', '进步最快之人'], bio: '场上可胜任中后卫、中场和门将。' },
        { id: 2, name: '代育锐', nickname: '球王', number: 10, pos: 'DF', apps: 4, goals: 0, asts: 0, role: 'CB/LB', saves: 0, cleanSheets: 0, motm: 0, rating: 6.9, avatarIcon: 'fa-shield-halved', traits: ['组织型中后卫'], memory: '累计出场 4 场', reviews: ['代队无敌', '全世界最好的代队', '10号体育生'], bio: '场上可胜任中后卫和左后卫。' },
        { id: 3, name: '王伯函', nickname: '放手大闸', number: 29, pos: 'DF', apps: 10, goals: 0, asts: 0, role: 'LB/CB', saves: 0, cleanSheets: 0, motm: 0, rating: 7.4, avatarIcon: 'fa-shield-halved', traits: ['防守型边后卫'], memory: '累计出场 10 场', reviews: ['纺大铲球第一人', 'if：对视；print：放铲', '纺大万比萨卡'], bio: '场上可胜任左后卫和中后卫。' },
        ...
        { id: 5, name: '曹维嘉', nickname: '能跑', number: 23, pos: 'FW', apps: 8, goals: 0, asts: 0, role: 'RB/RWF', saves: 0, cleanSheets: 0, motm: 0, rating: 7.3, avatarIcon: 'fa-person-running', traits: ['防守型边锋'], memory: '累计出场 8 场', reviews: ['边路超跑', '生康耐跑王', '生康跑车'], bio: '场上可胜任右后卫和右边锋。' },
        ...
        { id: 8, name: '彭卓伦', nickname: '发牌', number: 8, pos: 'MF', apps: 8, goals: 2, asts: 3, role: 'AM/LWF', saves: 0, cleanSheets: 0, motm: 0, rating: 8.0, avatarIcon: 'fa-compass', traits: ['组织型前锋'], memory: '贡献 2 粒进球 / 送出 3 次助攻', reviews: ['给过我很多助攻之人', '发牌～', '腿长14的技术型球员'], bio: '场上可胜任攻击型中场和左边锋。' },
        { id: 9, name: '周霄旭', nickname: '生康未来', number: 5, pos: 'FW', apps: 10, goals: 4, asts: 3, role: 'CF/RWF/AM', saves: 0, cleanSheets: 0, motm: 0, rating: 8.4, avatarIcon: 'fa-person-running', traits: ['全能前锋'], memory: '贡献 4 粒进球 / 送出 3 次助攻', reviews: ['生康未来', '贝林厄姆', '生康球王', '贝林厄姆', '生康未来'], bio: '场上可胜任中锋、右边锋和攻击型中场。' },
        { id: 10, name: '张俊', nickname: '全能王', number: 17, pos: 'DF', apps: 7, goals: 0, asts: 0, role: 'CB/CM/GK', saves: 0, cleanSheets: 0, motm: 0, rating: 7.1, avatarIcon: 'fa-shield-halved', traits: ['全能中场'], memory: '累计出场 7 场', reviews: ['有点万能', '让我看看热区图，我靠全红！', '我无处不在', '全能王'], bio: '场上可胜任中后卫、中场和门将。' },
        ...
        { id: 13, name: '吴全银', nickname: '控场', number: 25, pos: 'MF', apps: 3, goals: 0, asts: 0, role: 'DM/RB', saves: 0, cleanSheets: 0, motm: 0, rating: 6.8, avatarIcon: 'fa-compass', traits: ['全能中场'], memory: '累计出场 3 场', reviews: ['阿萨塔', '阿萨塔', '阿萨塔', '生康罗德里', '阿萨塔'], bio: '场上可胜任后腰和右后卫。' },
        ...
        { id: 15, name: '何嗣承', nickname: '生康坎特', number: 12, pos: 'MF', apps: 7, goals: 1, asts: 1, role: 'DM/LB', saves: 0, cleanSheets: 0, motm: 0, rating: 7.5, avatarIcon: 'fa-compass', traits: ['扫荡型中场'], memory: '贡献 1 粒进球 / 送出 1 次助攻', reviews: ['身体最硬之人', '生康坎特'], bio: '场上可胜任后腰和左后卫。' },
